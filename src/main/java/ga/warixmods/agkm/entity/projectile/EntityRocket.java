...
public class EntityRocket extends Entity implements IProjectile
{
    ...
    public EntityRocket(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_,EntityLivingBase owner)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityRocket(World worldIn, EntityLivingBase shooter, float velocity)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    DamageSource damagesource = DamageSource.wither;
                    ...
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase && movingobjectposition.entityHit != this.owner)
                        {
                        	System.out.println("Damaged" + movingobjectposition.entityHit.getDisplayName());
                 
                        	EntityLivingBase entitylivingbase = (EntityLivingBase) movingobjectposition.entityHit;
                        	entitylivingbase.attackEntityFrom(DamageSource.lightningBolt, 10);
                        }
                    }
                    else
                    {
            ...
            this.setPosition(this.posX, this.posY, this.posZ);
            this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, this.posX , this.posY , this.posZ , this.motionX, this.motionY, this.motionZ, new int[0]);
