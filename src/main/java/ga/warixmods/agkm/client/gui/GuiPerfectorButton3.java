...
public class GuiPerfectorButton3 extends GuiButton {
	protected static final ResourceLocation buttonTextures1 = new ResourceLocation("agkm:textures/gui/perfectorGUI.png");

	public GuiPerfectorButton3(int buttonId, int x, int y, String buttonText) {
    		  ...
    		  if (this.visible)
    	        {
    	            ...
    	            this.drawTexturedModalRect(this.xPosition, this.yPosition, k,146, this.width,this.height);
    	        }
    }
}
